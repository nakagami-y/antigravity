...
plan / report は明示しなくても自動で残す前提で扱います。
...
- 人間から受けた実作業の指示は、原則として plan と report を残す
- 雑談や軽微な確認だけは例外としてよい
...
非エンジニアのメンバーは、root `memory_bank/report/` の report を開いたら、まず次の 2 つを見れば大丈夫です。

- `まずこれだけ見ればOK`
- `AIが見たもの`

ここを見ると、AI がどの rule / workflow / skill / knowledge を見て、どの実行結果を出したかを追いやすくなります。
